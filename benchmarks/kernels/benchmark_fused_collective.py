...
1. FlashInfer's allreduce_fusion (fused allreduce + rmsnorm + optional quant) (both TRTLLM and MNNVL backends)
...
Usage with torchrun:
    ...
    torchrun --nproc_per_node=2 benchmark_fused_collective.py --backend mnnvl
...
try:
    ...
    if not hasattr(flashinfer_comm, "allreduce_fusion"):
...
# Global workspace for FlashInfer (unified workspace object)
_FI_WORKSPACE = None
...
def flashinfer_fused_allreduce_rmsnorm(
    ...
    flashinfer_comm.allreduce_fusion(
        ...
        launch_with_pdl=allreduce_params.launch_with_pdl,
        ...
        fp32_acc=allreduce_params.fp32_acc,
    )
...
def main():
    ...
    parser.add_argument(
        ...
        help="AllReduce backend to use (auto, trtllm, mnnvl). Default: auto",
    )
